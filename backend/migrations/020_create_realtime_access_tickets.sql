...
REVOKE ALL ON public.realtime_access_tickets FROM anon, authenticated, PUBLIC;
...
-- Explicit role revocation is required; revoking PUBLIC alone does not
-- remove existing explicit grants to anon/authenticated.
REVOKE ALL ON FUNCTION public.consume_realtime_access_ticket(text, uuid)
