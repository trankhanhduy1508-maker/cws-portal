 ...
 * Facebook qua Supabase Auth (LoginScreen.jsx) và các route như GET
 ...
 * vì chưa cấu hình Facebook Provider thật trong Supabase Dashboard nên
 ...
 * Facebook Provider thật — chỉ cần thêm @UseGuards(JwtAuthGuard).
 */
@Injectable()
