...
- Legacy `cws_worker_full.py`/`cws_worker.bat` được giữ làm reference knowledge, nhưng bị loại khỏi runtime package; không phải canonical package mới và không được import/launch.
